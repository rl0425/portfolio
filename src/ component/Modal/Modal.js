        ...
        if(type === "DEATS"){
            setData({
                ...
                summary: (
                    <div>
                        <span>
                            새로운 기술스택과 서비스를 개발하기 위해 아이디어 회의를 하던 중 나온 프로젝트입니다. <p/>
                            아동급식드림카드란 결식아동들을 위한 급식/부식을 무상으로 제공해주는 복지서비스입니다. 하지만 이를 사용할 수 있는 <p/>
                            식당과 편의점은 한정되어있고 그마저도 어디있는지에 대한 위치를 일일이 찾아보고 전화해야하는 상황이였습니다. <p/>
                            서울은 그나마 사이트가 친절하고 위치가 정확하게 나와있으나 대구는 그런 서비스가 없었습니다. <p/>
                            따라서 저희 팀은 아동급식드림카드를 사용할 수 있는 가게에 대한 정보/리뷰와 더불어 쉽게 찾아갈 수 있는 MAP 서비스를 연동하여, <p/>
                            기존의 복지카드를 사용하는 아이들을 위한 서비스를 개발하기로 결정했습니다. <br/>
                ...
                process: (
                    <div>
                        <span>
                            상당히 규모가 큰 프로젝트이라 많은 팀원들이 필요했기 때문에 디자이너 2명과, 프론트엔드 둘, 백엔드 한명으로 팀을 구성했습니다. <p/>
                            기존의 아동급식드림카드가 어떻게 사용자들에게 정보를 제공하는지를 먼저 파악했습니다. 서비스 자체는 대구권에서 전무하다고 볼 수 있었고, <p/>
                            비슷한 아이디어가 서울에서는 애플리케이션까지 개발된 상황이였습니다. 따라서 저희 또한 정보를 제공해줄 API를 가져와, <p/>
                            그 데이터를 어떻게 사용자들에게 더 친숙하게 보여줘야할지를 생각했습니다. 기존의 배달 서비스와 유사하게 정보를 제공한 후에, 주변 가게에 대한 <p/>
                            정보를 검색할 수 있게끔 했습니다. 정보를 제공하는 서비스를 개발하더라도 그 가게에 직접 찾아가야 했기 때문에 지도 서비스는 필수적이였습니다. <p/>
