        ...
        if(type === "qdrop"){
            setData({
                ...
                summary: (
                    <div>
                        <span>
                            취업준비 과정에서 면접준비를 철저하게 하는 것은 가장 중요한 일 중 하나입니다. <p/>
                            회사를 그만두고 면접질문에 관한 공부를 하던 중, 이러한 질문들을 한 곳에서 볼 수 있고 또  내가 작성할 수 있는 공간의 필요성을 느꼈습니다.<p/>
                            하지만 당시 제가 원하는 간단하게 핵심만 추려진 사이트나 애플리케이션은 시중에 존재하지 않았고, <p/>
                            사이드 프로젝트의 필요성도 느끼던 참에 리엑트 공부와 면접공부를 같이 할 수 있는 장점으로 제가 구현하기로 결심했습니다. <p/>
