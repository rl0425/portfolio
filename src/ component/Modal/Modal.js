                ...
                process: (
                    <div>
                        <span>
                            ...
                            그러나 해외 사이트인 ESPN 에서 적합한 API를 발견했고 저작권 관련 정보를 확인한 후 개발을 시작했습니다. <p/>
                ...
                complete: (
                    <div>
                        <span style={{lineHeight:"28px"}}>
                            리액트로 개발한 프로젝트였습니다. 기존 사용하던 Vanila JS는 많은 차이가 있어서 처음에는 낯선 개념들이 많았습니다. <br/>
                            리액트에서는 기존의 DOM 조작 방식으로 요소를 선택하고 변경하는 것이 불가능해, 처음부터 작은 단위로 컴포넌트를 나누어 설계하고 이를 조합해야 합니다. 이 부분이 처음에는 익숙하지 않아 어려움을 겪었습니다. <p/>

                            하지만 학습을 통해 새로운 개념들을 익히면서, HTML과 유사한 문법인 JSX, state와 생명주기 메서드, 상태 관리를 위한 라이브러리 등 많은 개념들을 익힐 수 있었습니다.
                            이 프로젝트에서는 컴포넌트를 분리하여 코드의 재사용성과 모듈화를 쉽게 구성할 수 있었고, Redux를 통해 상태 관리를 용이하게 했습니다.
                            ...
                            이러한 어려움은, 분야별로 업무를 나누어서 작업하는 것이 훨씬 효율적이며 전문성을 극대화 시킬 수 있다는 점을 깨달았습니다. <br/>
        ...
        if(type === "evaluation"){
            setData({
                ...
                summary: (
                    <div>
                        <span>
                            해당 프로젝트는 이전 회사에서에서 진행한 프로젝트입니다. <p/>
